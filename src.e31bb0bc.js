...
var CountdownTimer = /*#__PURE__*/function () {
  function CountdownTimer(_ref) {
    ...
    _defineProperty(this, "updateTimer", function () {
      ...
      _this.days.textContent = _this.countTime().days;
      _this.hours.textContent = _this.countTime().hours;
      _this.mins.textContent = _this.countTime().mins;
      _this.secs.textContent = _this.countTime().secs;
    });
  ...
  _createClass(CountdownTimer, [{
    ...
    value: function getTime() {
      ...
      var time = this.targetDate - timeNow;
      return time;
    }
  }, {
    key: "countTime",
    value: function countTime() {
      ...
      var days = Math.floor(time / (1000 * 60 * 60 * 24)).toString().padStart(2, '0');
      var hours = Math.floor(time % (1000 * 60 * 60 * 24) / (1000 * 60 * 60)).toString().padStart(2, '0');
      var mins = Math.floor(time % (1000 * 60 * 60) / (1000 * 60)).toString().padStart(2, '0');
      var secs = Math.floor(time % (1000 * 60) / 1000).toString().padStart(2, '0');
      return {
        hours: hours,
        days: days,
        mins: mins,
